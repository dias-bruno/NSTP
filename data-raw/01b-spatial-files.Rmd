...
census_tracts <- census_tracts %>% 
  dplyr::select(GeoUID, name, `Shape Area`, Population, Households, CD_UID, CMA_UID, geometry) %>% 
  ...
  dplyr::select(CTUID,CTNAME, LANDAREA, PCD, CMAUID, PRUID, Population, Households, geometry)
```
...
```{r}
directory <- paste0(here(), "/data-raw/output/PCD3525/spatial-files/")
