---
title: "Creating spatial filters"
...
After calculating accessibility, we will now advance our analysis by developing regression
...
imply causality" [@cunningham2021causal]. Therefore, it is important to
...
no-vehicle households [@merlin2017], transit accessibility and car
...
counterpart that accurately reproduces a spatial random variable. 
...
measures_folder <- paste0(here::here(),"/data-raw/output/",code_label,"/CT/accessibility-measures/")
...
# Folder  
directory_spatial_files <- paste0(here(),"/data-raw/output/",code_label,"/spatial-files/") # Update it if necessary 

# Read file
ct_file <- st_read(paste0(directory_spatial_files, "census_tracts.gpkg"))
```
...
```{r directory-export}
diretorio_export_figures <- paste0(here(),"/data-raw/output/",code_label,"/CT/spatial-filter-figures/") # Update the address to export the data, if necessary

if(!dir.exists(diretorio_export_figures)){
  dir.create(diretorio_export_figures, recursive = TRUE)}

diretorio_export_tables <- paste0(here(),"/data-raw/output/",code_label,"/CT/spatial-filter-measures/") # Update the address to export the data, if necessary
...
```{r sf-dist-figure, out.width="100%"}
...
```{r sf-contiguity-map, out.width="100%"}
...
```{r sf-contiguity-map-fig, out.width="100%"}
...
```{r sfpp-contiguity-map-fig, out.width="100%"}
...
```{r ht-dist-figure, out.width="100%"}
...
```{r ht-contiguity-map-fig, out.width="100%"}
