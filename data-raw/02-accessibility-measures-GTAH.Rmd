...
```{r read-ttm}
ttm_folder <- paste0(here(),"/data-raw/output/GTAH/CT/travel_times/")
...
confirm_ttmf <- ttm_f %>% 
  ...
  dplyr::summarise(distribution = first(distribution),
                   est_1 = first(est_1),
                   est_2 = first(est_2),)
...
```{r directory-export}
diretorio_export <- paste0(here(),"/data-raw/output/GTAH/CT/accessibility-measures/") # Update the address to export the data, if necessary
