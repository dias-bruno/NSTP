...
\begin{figure}
\includegraphics[width=1\linewidth]{study_area_map} \caption{Map of the study area.}\label{fig:study-area-map}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{DAG} \caption{Causal diagram of calculated accessibility on perceived accessibility.}\label{fig:DAG}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{SA_pp_3modes_v2_clipped} \caption{Maps of the multimodal spatial availability per person, considering active, public transit and motorized modes.}\label{fig:multi-sa-pp}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{accessibility-threshold-v2} \caption{Public transit accessibility thresholds based on selected individual profiles.}\label{fig:transit-accessibility-thresholds}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{accessibility-active-threshold} \caption{Active accessibility thresholds based on selected individual profiles.}\label{fig:active-accessibility-thresholds}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{geographical_priorities} \caption{Priority areas for policy intervention by type of equity standard.}\label{fig:priority_areas}
\end{figure}
